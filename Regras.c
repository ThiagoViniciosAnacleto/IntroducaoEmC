...
char letra = 'A'//adiciona apenas UM caracter, utilizar aspas simples
char frase[10] = "Cachorro"; //adiciona varios caracteres, utiliar aspas dupla
double n3 = 10.2334; //adiciona um valor real ( com casas decimais ) porém com dupla precisão
